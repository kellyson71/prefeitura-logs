...
function buildVscodeLine(lineRaw, lineNum) {
    ...
    html = html.replace(/(\/home[A-Za-z0-9_.\/-]+\.php)\b/g, '<span class="hl-path" title="Acessar sub-diretório">$1</span>');
...
function openConsole(logStrEnc) {
    try {
        ...
        DOM.consoleBody.innerHTML = finalHtml || '<div class="px-4 py-2 text-vs-muted italic">Arquivo lido é infinito ou está vazio.</div>';
    } 
    catch(e) { console.error('Erro ao abrir log', e); }
}
